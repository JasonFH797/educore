...
public class SeccionController {
    ...
    public boolean aulaTieneSecciones(
    ...
    public void agregarEstudiante(
        ...
        Seccion seccion =
                buscarSeccionObligatoria(seccionId);

        Estudiante estudiante =
                buscarEstudianteObligatorio(estudianteId);
    ...
    public void removerEstudiante(
        ...
        if (!removido) {
            throw new IllegalArgumentException(
                    "El estudiante no está inscrito en la sección.");
        }
    ...
    private Aula buscarAulaPorId(
        ...
        throw new IllegalArgumentException(
                "No existe un aula con el ID indicado.");
    }

    private Empleado buscarDocenteValido(
            int docenteId) throws Exception {
    ...
    private Seccion buscarSeccionObligatoria(
    ...
    private Estudiante buscarEstudianteObligatorio(
            int estudianteId) throws Exception {
