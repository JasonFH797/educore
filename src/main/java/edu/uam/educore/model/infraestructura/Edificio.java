...
/**
 * Representa un edificio dentro del centro educativo. Cada edificio posee un identificador, un
 * código único, un nombre y una colección de aulas asociadas.
 */
public class Edificio {
  ...
  /**
   * Constructor de la clase Edificio. Inicializa los datos básicos del edificio.
   *
