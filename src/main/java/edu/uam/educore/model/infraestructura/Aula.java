...
/**
 * Representa un aula dentro de un edificio del centro educativo. Cada aula posee un identificador,
 * un código, una capacidad, un tipo de aula y el edificio al que pertenece.
 */
public class Aula {
  ...
  /**
   * Constructor de la clase Aula. Inicializa los datos básicos del aula.
   *
  ...
  public String getInfo() {
    String nombreEdificio = (edificio != null) ? edificio.getNombre() : "Sin edificio";

    return String.format(
        "[%s] %s | Capacidad: %d | Edificio: %s", tipo, codigo, capacidad, nombreEdificio);
  }
}
