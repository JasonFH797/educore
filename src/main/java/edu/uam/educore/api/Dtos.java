...
/**
 * Un DTO (Data Transfer Object) es un record de solo datos que traduce
 * una entidad de dominio al JSON que consume el frontend, y viceversa.
 */
public final class Dtos {
    ...
    public record EstudianteDto(
        ...
        public static EstudianteDto desde(Estudiante estudiante) {
            ...
            Double beca =
                    estudiante instanceof EstudianteBecado becado
                            ? becado.getPorcentajeBeca()
                            : null;
    ...
    public record EmpleadoDto(
        ...
        public static List<EmpleadoDto> listaDesde(
    ...
    public record EdificioDto(
        ...
        public static EdificioDto desde(
                Edificio edificio) {
        ...
        public static List<EdificioDto> listaDesde(
            ...
            List<EdificioDto> resultado =
                    new ArrayList<>();

            for (Edificio edificio : edificios) {
                resultado.add(
                        EdificioDto.desde(edificio));
            }
    ...
    public record EstudianteResumenDto(
        ...
        public static EstudianteResumenDto desde(
    ...
    public record SeccionDto(
        ...
        public static SeccionDto desde(
                Seccion seccion) {
            ...
            return new SeccionDto(
                    ...
                    seccion.getDocente().getNombre()
                            + " "
                            + seccion.getDocente().getApellidos(),
        ...
        public static List<SeccionDto> listaDesde(
            ...
            List<SeccionDto> resultado =
                    new ArrayList<>();

            for (Seccion seccion : secciones) {
                resultado.add(
                        SeccionDto.desde(seccion));
            }
