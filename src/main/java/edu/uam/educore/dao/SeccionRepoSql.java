...
public class SeccionRepoSql extends Repositorio<Seccion> {
    ...
    public void guardar(Seccion seccion) throws Exception {
        ...
        String sql =
                "INSERT INTO seccion "
                + "(codigo, nombre, docente_id, aula_id) "
                + "VALUES (?, ?, ?, ?)";
                ...
                try (PreparedStatement ps =
                    ...
                    if (filas == 0) {
                        throw new IllegalArgumentException(
                                "No existe la sección que se desea actualizar.");
                    }
                }
    ...
    public void eliminar(int id) throws Exception {
        ...
        try (Connection con = abrir();
            ...
            if (filas == 0) {
                throw new IllegalArgumentException(
                        "No existe una sección con el ID indicado.");
            }
        }
    }
    ...
    private Empleado mapearDocente(ResultSet rs) throws Exception {
        ...
        LocalDate fechaIngreso =
                rs.getDate("docente_fecha_ingreso").toLocalDate();
    ...
    private void cargarEstudiantes(
            Connection con,
            Seccion seccion) throws Exception {
    ...
    private Estudiante mapearEstudiante(
    ...
    private void sincronizarMatriculas(
        ...
        String eliminar =
                "DELETE FROM matricula WHERE seccion_id = ?";
