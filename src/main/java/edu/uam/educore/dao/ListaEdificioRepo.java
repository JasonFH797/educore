...
/**
 * Repositorio en memoria para administrar los edificios. Implementa las operaciones CRUD utilizando
 * una lista dinámica.
 */
public class ListaEdificioRepo extends Repositorio<Edificio> {
   ...
   *
   * @param id identificador del edificio.
   * @return Optional que contiene el edificio si existe, o Optional.empty() si no fue encontrado.
